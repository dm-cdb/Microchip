...
This code has been tested with positive T°C value as well as negative T°C ; unlike the DHT11, it decrements correctly the negative value without bugging between -N,9 decimal and the
