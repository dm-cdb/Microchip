...
On our project we set Capture mode on every 4th rising edge. This means that if the input signal is 500Hz, the output signal on GP2 will be 500 / 4 (4th rising edge) / 2 (GP2 toggle at each interrupt ) => 62,5 Hz<br>
...
General formula for computing a period on CCP1 :<br>
