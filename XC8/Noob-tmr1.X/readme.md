...
We also enable the TMR1 interrupt : GIE o= 1, PEIE = 1 in INTCON register, and TMR1IE = 1 in PIE1 register.
...
However we preset  TMR1H:TMR1 register with TMR1H = 0x0B and TMR1L = 0xDB   => 0x0BDB = 3035.<br>
The interrupt will then trigger in (65535 - 3035) * 8 * 1µs = 0,5 sec (8 is the prescaler).<br>
The interrupt routine increment a user defined variable, and when this variable == 2, it toggle a led (HIGH = 1 sec ; LOW = 1 sec).<br>
