 ...
 * Driving an LCD with shift register
 ...
 * Created on March 11th 2023, 08:30
 */
...
#define FCYC FOSC/4             //Instruction freq
...
const unsigned char myText2[] = "With HC164";
...
void init_Pic() {
    ...
    TRISIO = 0b00011000;            // GP3-2-4 inputs (1), 1/2/5 outputs (0)
