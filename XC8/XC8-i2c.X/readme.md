...
If using different clock frequency, adapt i2c.h
...
Below are the timers from NXO (formerly Philips Semiconductor, the inventor of this protocol) :


![figure-8](https://github.com/user-attachments/assets/86ea17a6-1156-4dff-88da-acae312c627e)


This is how the serial transmission looks like :<br>
- SDA is used for the data bits
- SCL is the serial clock that times the bit sequence.

  
 ![address-data-frame](https://github.com/user-attachments/assets/83d627f6-5517-4a8d-b11d-3744ba5c528f)
