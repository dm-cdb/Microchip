...
CAREFUL: the programming of this pic will overwrite the factory oscillator calibration value (OSCCAL) and the bandgap calibration bit in the config word.<br>
